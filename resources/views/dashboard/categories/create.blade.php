<x-app-layout>
    <div class="max-w-7xl mx-auto p-6 md:p-10 space-y-8">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <h1 class="text-3xl font-bold text-white tracking-tight">Crear una Categoria para Ponencias</h1>
                <p class="text-slate-400 mt-1">Introduce los datos y crea una categoria para las ponencias</p>
            </div>
        ...
        <!-- Formulario Creacion Categoria de Ponencia -->
