    ...
    <div class="h-screen">
        <div class="transform translate-z-0">
            <div class="mb-6 text-center sticky top-0 z-50 pt-4 glass-header pb-4">
                ...
                <div class="glass-panel p-4 rounded-2xl max-w-5xl mx-auto flex items-center gap-4">
                    ...
                    <div class="flex items-center gap-1.5">
                        ...
                        <span class="text-xs font-medium text-blue-400">{{ $poster->category->name }}</span>
                    </div>
                </div>
            </div>
