...
@section('title', '401 - No Autorizado - SIGEC')

@section('content')
    <h1 class="pt-12 pb-8 text-4xl text-center font-bold text-white tracking-tight mb-8">Debes iniciar sesión para acceder a esta página.</h1>
