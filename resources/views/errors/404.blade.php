...
@section('title', 'Contenido no encontrado - SIGEC')

@section('content')
    <h1 class="pt-12 pb-8 text-4xl text-center font-bold text-white tracking-tight mb-8">Lo sentimos, el contenido no fue encontrado.</h1>
