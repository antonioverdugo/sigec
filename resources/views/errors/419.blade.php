...
@section('title', '400 - Solicitud Incorrecta - SIGEC')

@section('content')
    <h1 class="pt-12 pb-8 text-4xl text-center font-bold text-white tracking-tight mb-8">Tu sesión ha expirado por inactividad.</h1>
