...
@section('title', '405 - Método No Permitido - SIGEC')

@section('content')
    <h1 class="pt-12 pb-8 text-4xl text-center font-bold text-white tracking-tight mb-8">El método de solicitud no está permitido para esta acción.</h1>
