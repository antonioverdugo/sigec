...
/**
 * Request para actualizar un patrocinador.
 *
 * Valida los datos de entrada al modificar un patrocinador
 * existente en el sistema, incluyendo nombre, correo, teléfono, monto de contribución y tipo.
 *
 *
...
class UpdateSponsorRequest extends FormRequest
{
    ...
    /**
     * Reglas de validación para actualizar un patrocinador.
     *
     * - name: obligatorio, texto, entre 3 y 200 caracteres
     * - email: obligatorio, formato válido de correo, único en sponsors (excluye actual)
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'name' => 'required|string|min:3|max:200|unique:sponsors,name|regex:/^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s\-]+$/',
            'email' => [
                'required',
