        ...
        <div class="min-h-screen bg-dark-mesh text-slate-300 flex">
            ...
            <aside
                ...
                <div class="h-24 flex items-center justify-center border-b border-slate-800/50">
                    <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center space-x-3 hover:opacity-80 transition-opacity">
                        <div class="inline-flex items-center justify-center overflow-hidden w-20 h-20 rounded-[1rem]">
                            <img src="<?php echo e(asset('img/logo.png')); ?>" alt="SIGEC Logo" class="w-full h-full object-contain scale-[1.5]">
                        </div>
                    </a>
                </div>
                ...
                <div class="px-4 py-4 border-b border-slate-800/50" x-data="{ open: false }">
                    <button @click="open = !open" class="w-full flex items-center space-x-3 hover:bg-slate-800/50 p-2 rounded-xl transition-all">
                        <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(Auth::user()->name)); ?>&background=3b82f6&color=fff" alt="<?php echo e(Auth::user()->name); ?>"
                            class="w-10 h-10 rounded-full border-2 border-slate-700">
                        <div class="flex-1 text-left">
                            <h4 class="text-sm font-semibold text-white"><?php echo e(Auth::user()->name); ?></h4>
                    ...
                    <!-- Dropdown Menu -->
                    <div x-show="open" @click.away="open = false" class="mt-2 py-2 bg-slate-800 rounded-xl border border-slate-700 overflow-hidden" style="display: none;">
                        <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center space-x-3 px-4 py-3 text-sm text-slate-300 hover:bg-slate-700/50 hover:text-white transition-all">
                ...
                <footer class="p-4 border-t border-slate-800/50 text-center">
                    <p class="text-xs text-slate-500">&copy; <?php echo e(date('Y')); ?> Antonio Ramón Verdugo García</p>
                </footer>
            </aside>
            ...
            <main class="flex-1 flex flex-col h-screen overflow-hidden relative">
                <!-- Mobile Header -->
                <header class="h-16 md:hidden flex items-center justify-between px-4 border-b border-slate-800 glass-panel z-40">
...
<?php /**PATH /home/luciantoniopo/sigec/resources/views/layouts/app.blade.php ENDPATH**/ ?>