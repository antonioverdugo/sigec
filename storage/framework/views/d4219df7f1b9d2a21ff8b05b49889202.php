...
<body class="font-sans antialiased">
    <div class="min-h-screen bg-dark-mesh text-slate-300 flex">
        ...
        <aside
            ...
            <div class="h-24 flex items-center justify-center border-b border-slate-800/50">
                <a href="<?php echo e(route('dashboard')); ?>"
                    ...
                    <div class="inline-flex items-center justify-center overflow-hidden w-20 h-20 rounded-[1rem]">
                        <img src="<?php echo e(asset('img/logo.png')); ?>" alt="SIGEC Logo"
            ...
            <div class="px-4 py-4 border-b border-slate-800/50" x-data="{ open: false }">
                <button @click="open = !open"
                    ...
                    <div
                        ...
                        <?php echo e(collect(explode(' ', Auth::user()->name))->map(fn($w) => Str::substr($w, 0, 1))->take(2)->implode('')); ?>

                    </div>
                    <div class="flex-1 text-left">
                        <h4 class="text-sm font-semibold text-white"><?php echo e(Auth::user()->name); ?><br>(
                            <?php echo e(ucwords(Auth::user()->role->name)); ?> )
                        </h4>
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                ...
                <a href="<?php echo e(route('dashboard')); ?>"
                    class="flex items-center space-x-3 px-4 py-3 text-sm font-medium rounded-xl transition-all <?php echo e(request()->routeIs('dashboard') ? $activeLink : $inactiveLink); ?>">
    ...
    <?php if(($mensaje = Session::get('message')) && ($icono = Session::get('icon'))): ?>
        <script>
            Swal.fire({
                position: "center",
